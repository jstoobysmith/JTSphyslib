...
for any local-gauge-data package `jets`. For a free package the classification of invariants
of `Physlib.ClassicalFieldTheory.GaugeTheory.GaugeField.Symmetrized` then applies: a gauge
invariant of the gauge-boson jet algebra is a polynomial in the covariant derivatives of the
field strength, `GaugeJetAlgebra.invariant_mem_adjoin_fieldStrength`.
-/
