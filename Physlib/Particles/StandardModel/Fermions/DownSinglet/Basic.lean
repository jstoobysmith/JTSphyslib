...
/-- **The centre of `SL(2,ℂ)` acts on the down-singlet space by `-1`**: the value space carries a
...
/-- The centre acts on the conjugate down-singlet space by `-1` as well: conjugation does not
  move a real sign. -/
