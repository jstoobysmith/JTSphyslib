...
public import Physlib.ClassicalFieldTheory.GaugeTheory.GaugeBoson.IsGaugeField
...
`Physlib.ClassicalFieldTheory.GaugeTheory.GaugeField`. This file establishes that
...
theorem isGaugeField :
    IsGaugeField localGaugeData (B := JetAlgebra) repLorentzGroup repJetGaugeGroupI gaugeField where
  lorentz_apply Λ n l μ φ :=
    (repLorentzGroup_includeGauge Λ
        ((GaugeJetAlgebra.gaugeField GaugeAlgebra) (List.ofFn l) μ φ)).trans <|
      (congrArg includeGauge
          ((GaugeJetAlgebra.isGaugeField localGaugeData).lorentz_apply Λ n l μ φ)).trans <|
  ...
  gauge_apply_deriv U s μ φ :=
    ...
    (congrArg includeGauge
      ((GaugeJetAlgebra.isGaugeField localGaugeData).gauge_apply_deriv U s μ φ)).trans <| by
