...
and compatible with `massWeightPoly`. That is the structure `IsHiggsSector`, together with
...
noncomputable def higgs  (h : IsHiggsSector B rep repLorentz massWeightPoly)
...
noncomputable def barHiggs (h : IsHiggsSector B rep repLorentz massWeightPoly)
    {n : ℕ} (d : Fin n → (Fin 1 ⊕ Fin 3)) (i : Fin 2) : B :=
...
noncomputable def higgsSubmodule (h : IsHiggsSector B rep repLorentz massWeightPoly) (n : ℕ) :
...
noncomputable def barHiggsSubmodule (h : IsHiggsSector B rep repLorentz massWeightPoly)
...
noncomputable def dotGaugeHiggs (h : IsHiggsSector B rep repLorentz massWeightPoly)
...
def higgsAlgebra (h : IsHiggsSector B rep repLorentz massWeightPoly) :
...
noncomputable def massWeightSubmodule
    (h : IsHiggsSector B rep repLorentz massWeightPoly) (n : ℕ) :
    Submodule ℂ B :=
