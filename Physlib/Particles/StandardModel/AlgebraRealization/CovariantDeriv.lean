...
infinitesimal action of its species (`LocalGaugeData.actionConj` of it for a conjugate
...
noncomputable def covDerivBarH {n : ℕ} (l : Fin n → (Fin 1 ⊕ Fin 3)) :
  ...
  IsGaugeField.covDerivIter h.A (LocalGaugeData.actionConj HiggsVec.gaugeAlgebraAction) h.barH n l 0
...
lemma fieldAlgebra_eq_covDeriv :
  ...
  · rintro b ((hb | hb) | hb)
    ...
    · simp only [Set.mem_iUnion] at hb
      ...
      · exact IsGaugeField.symbol_mem_adjoin (LocalGaugeData.actionConj HiggsVec.gaugeAlgebraAction)
    ...
    · simp only [Set.mem_iUnion] at hb
      ...
      · exact IsGaugeField.symbol_mem_adjoin
          (LocalGaugeData.actionConj DownSinglet.gaugeAlgebraAction) (h.bard i) hA
          (fun n l φ => Or.inr (Or.inr (Set.mem_iUnion_of_mem i (Set.mem_iUnion_of_mem n
      ...
      · exact IsGaugeField.symbol_mem_adjoin
          (LocalGaugeData.actionConj UpSinglet.gaugeAlgebraAction) (h.baru i) hA
          (fun n l φ => Or.inr (Or.inr (Set.mem_iUnion_of_mem i (Set.mem_iUnion_of_mem n
      ...
      · exact IsGaugeField.symbol_mem_adjoin
          (LocalGaugeData.actionConj QuarkDoublet.gaugeAlgebraAction) (h.barQ i) hA
          (fun n l φ => Or.inr (Or.inr (Set.mem_iUnion_of_mem i (Set.mem_iUnion_of_mem n
      ...
      · exact IsGaugeField.symbol_mem_adjoin
          (LocalGaugeData.actionConj LeptonDoublet.gaugeAlgebraAction) (h.barL i) hA
          (fun n l φ => Or.inr (Or.inr (Set.mem_iUnion_of_mem i (Set.mem_iUnion_of_mem n
      ...
      · exact IsGaugeField.symbol_mem_adjoin
          (LocalGaugeData.actionConj LeptonSinglet.gaugeAlgebraAction) (h.bare i) hA
          (fun n l φ => Or.inr (Or.inr (Set.mem_iUnion_of_mem i (Set.mem_iUnion_of_mem n
