...
the base point. The covariant form of the theory is written
...
ordered-tuple indexing used by the covariant form of the theory, assembles the subalgebra they
...
The second half establishes the laws those towers satisfy, which
`CovAlgebraRealization` collects into the covariant form of the theory.
...
it. So every one of those laws is unconditional.
...
- K. The Lorentz law of the field-strength tower
...
`IsGaugeSector` and the cross-sector `F_comm_*` rules at once.
...
The sector structures take the multiplicativity of the two actions on `B` as explicit
...
commutation obligations of the three sector structures.
