...
theorem boostWeight_inter_fieldStrength :
  ...
  · rintro x (⟨a, (rfl | rfl), b, (rfl | rfl), rfl⟩ | ⟨a, (rfl | rfl), b, (rfl | rfl), rfl⟩) <;>
      exact Submodule.subset_span (by
        simp [fieldStrengthDeriv_mul_comm 0 0 (Sum.inl 0) (Sum.inr 2) (Sum.inr 0) (Sum.inr 1)])
  · rintro x (rfl | rfl | rfl | rfl | rfl | rfl | rfl)
    exacts [Submodule.subset_span (Set.mem_union_right _ (Set.mul_mem_mul (by simp) (by simp))),
      Submodule.subset_span (Set.mem_union_right _ (Set.mul_mem_mul (by simp) (by simp))),
      Submodule.subset_span (Set.mem_union_right _ (Set.mul_mem_mul (by simp) (by simp))),
      Submodule.subset_span (Set.mem_union_right _ (Set.mul_mem_mul (by simp) (by simp))),
      Submodule.subset_span (Set.mem_union_left _ (Set.mul_mem_mul (by simp) (by simp))),
      Submodule.subset_span (Set.mem_union_left _ (Set.mul_mem_mul (by simp) (by simp))),
      Submodule.subset_span (Set.mem_union_left _ (Set.mul_mem_mul (by simp) (by simp)))]
