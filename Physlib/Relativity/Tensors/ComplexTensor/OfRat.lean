...
lemma contr_basis_ratComplexNum {c : complexLorentzTensor.Color}
  ...
  match c with
  | Color.upL =>
    change Fermion.leftDualContraction (Fermion.LeftHandedWeyl.basis i ⊗ₜ Fermion.DualLeftHandedWeyl.basis j) = _
    rw [Fermion.leftDualContraction_basis]
    simp
  | Color.downL =>
    change Fermion.dualLeftContraction (Fermion.DualLeftHandedWeyl.basis i ⊗ₜ Fermion.LeftHandedWeyl.basis j) = _
    rw [Fermion.dualLeftContraction_basis]
    simp
  | Color.upR =>
    change Fermion.rightDualContraction (Fermion.RightHandedWeyl.basis i ⊗ₜ Fermion.DualRightHandedWeyl.basis j) = _
